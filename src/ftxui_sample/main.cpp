...
// configuration step. It creates a namespace called `crow_example`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", crow_example::cmake::project_name, crow_example::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", crow_example::cmake::project_version);
      return EXIT_SUCCESS;
    }
